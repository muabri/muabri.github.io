        ...
        l.boot = function(t, n) {
            ...
            if (o.length) {
                var r = new XMLHttpRequest
                  , a = (e.eappsCustomPlatformUrl ? e.eappsCustomPlatformUrl : "") + "/assets/js/pages/" + o[0] + ".json"
                  , s = i.stringify({
                    w: o.join(",")
                });
                r.open("get", a + "?" + s),
    ...
    (function(t) {
        var n = function(e) {
            var n = this
              , o = !1
              , i = []
              , r = t.eappsCustomPlatformUrl || "https://gosocial.co.id";
